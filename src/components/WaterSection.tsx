...
const WaterSection = ({ lang }: WaterSectionProps) => {
  const t = {
    en: {
      ...
      desc: "The Foundation of Everything:\n\nThis Isn't Just Water.\n\nIt's Kangen Water—The Power of Molecular Hydrogen.\n\nYour body is 70% water. What if the water you've been drinking your entire life has been working against you? Kangen Water is medical-grade, hydrogen-rich, ionized water used by over 6,500 doctors in Japan. It's not a trend; it's 52-plus years of proven science.",
      benefits: [
      ...
      buyGuideNote: "You'll be ordering directly through Enagic's official system—safe, secure, and backed by 52+ years of excellence.",
    ...
    es: {
      ...
      buyGuideNote: "Estarás ordenando directamente a través del sistema oficial de Enagic—seguro, protegido y respaldado por más de 52 años de excelencia.",
