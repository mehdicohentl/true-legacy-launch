      ...
      <main className="pt-24 pb-20">
        <article className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="/global/join" className="cta-shimmer inline-flex items-center justify-center gap-3 px-8 py-4 rounded-xl font-body font-black text-base uppercase tracking-[0.1em] bg-accent text-accent-foreground shadow-gold animate-pulse-glow">
